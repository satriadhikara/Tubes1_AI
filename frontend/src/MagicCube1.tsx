...
const MagicCube: React.FC = () => {
    ...
    const cameraRef = useRef<THREE.PerspectiveCamera | null>(null); // INITIAL POSISI
    ...
    useEffect(() => {
        ...
        camera.position.copy(initialCameraPosition); // SET
        cameraRef.current = camera; // SET POSISI
    ...
    const resetCamera = () => { // FUNGSI UNTUK BUTTON RESET
